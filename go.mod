...
// Mirrors the replace set of netbirdio/netbird v0.79.0. A dependency's own
// replace directives are ignored, so they have to be restated here or the
